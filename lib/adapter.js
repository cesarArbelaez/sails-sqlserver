  ...
  var adapter = {
    ...
    connectConnection: function(connection, cb){
      ...
      if (isPersistent && (!datastores[connection].mssqlConnection || !datastores[connection].mssqlConnection.connected)) {
        datastores[connection].mssqlConnection = new mssql.ConnectionPool(marshalConfig(datastores[connection].config));
        ...
        datastores[connection].mssqlConnection[uniqId] = new mssql.ConnectionPool(marshalConfig(datastores[connection].config));
